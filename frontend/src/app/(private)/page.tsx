        ...
        <div className="flex justify-left items-left mb-4">
          <form onSubmit={handleSearch} className="w-full sm:w-auto flex items-center justify-center">
            <select
              ...
              className="lg:px-4 py-2 border border-gray-300 dark:bg-gray-700 rounded-l-md w-20 lg:w-auto h-10 lg:h-16 focus:outline-none focus:ring-1 focus:ring-[#D91A9C]"
            >
            ...
            <input
              ...
              className="w-full lg:w-[750px] px-4 py-2 border border-gray-300 dark:bg-gray-700 h-10 lg:h-16 focus:outline-none focus:ring-1 focus:ring-[#D91A9C]"
            />
