...
const TermsConditionsPage = () => {
  return (
    <>
      <Head>
        <title>Terms of Service | devolvedai.com</title>
      ...
      <main className="container">
        ...
        <section className="content">
          ...
          <p>
            These Terms of Service and any terms expressly incorporated herein (“Terms”) apply to your access to and use of all services (our “Services”) provided by devolvedai.com (“Company,” “we,” or “us”).
          </p>
          ...
          <ul>
            <li>(a) create a strong password that you do not use for any other website or online service;</li>
            <li>(b) provide accurate and truthful information;</li>
            <li>(c) maintain and promptly update your Account information;</li>
            <li>(d) maintain the security of your Account by protecting your Account password and restricting access to your computer and your Account;</li>
            <li>(e) promptly notify us if you discover or otherwise suspect any security breaches related to your Account; and</li>
            <li>(f) take responsibility for all activities that occur under your Account and accept all risks of any authorized or unauthorized access to your Account, to the maximum extent permitted by law.</li>
          </ul>
          <p>
            When you create an Account, we assign you an account identifier that you must retain to access your Account.
          </p>

          <h2>3. DISCONTINUANCE OF SERVICES</h2>
          <p>
          ...
          <ul>
            <li>(a) passwords being "Bruteforced",</li>
            <li>(b) server failure or data loss,</li>
            <li>(c) forgotten passwords,</li>
            <li>(d) corrupted wallet files,</li>
            <li>(e) incorrectly constructed transactions or mistyped Polygon PoS Chain addresses; or</li>
            <li>(f) unauthorized access to mobile applications,</li>
            <li>(g) "phishing," viruses, third-party attacks or any other unauthorized third-party activities.</li>
          </ul>
          ...
          <ul>
            ...
            <li>Engage in Automated Data Collection (scraping) unless such Automated Data Collection is confined solely to search indexing for display on the Internet;</li>
            <li>Engage in the reproduction of any content posted (such as public labels or name tags) or extracted from our APIs, CSV exports or our website or any of our affiliate websites without our prior consent or authorization;</li>
          ...
          <p>
            7.5. To the extent this agreement is not enforceable by applicable law, you grant devolvedai.com the rights we need to use your content without attribution and to make reasonable adaptations of your content as necessary to render the Website and provide the service.
          </p>

          <h2>8. COPYRIGHTS AND OTHER INTELLECTUAL PROPERTY RIGHTS</h2>
          <p>
          ...
          <p>
            Unauthorized use and/or duplication of this material without express and written permission from this site’s author and/or owner is strictly prohibited. Excerpts and links may be used, provided that full and clear credit is given to devolvedai.com with appropriate and specific direction to the original content.
          </p>
          <p>
            For comprehensive details regarding the submission of DMCA notices, including our designated agent's contact information and procedural guidelines, please refer to our DMCA Policy.
          </p>

          <h2>9. TRADEMARKS</h2>
          <p>
            “devolvedai.com” the Company logo, and any other Company product or service names, logos or slogans that may appear on our Services are trademarks of Company and may not be copied, imitated or used, in whole or in part, without our prior written permission.
          </p>
          <p>
          ...
          <p>Please see our detailed Privacy Policy.</p>
          ...
          <ul>
            <li>(a) your use of, or conduct in connection with, our Services;</li>
            <li>(b) any Feedback you provide;</li>
            <li>(c) your violation of these Terms; or</li>
            <li>(d) your violation of any rights of any other person or entity.</li>
          </ul>
