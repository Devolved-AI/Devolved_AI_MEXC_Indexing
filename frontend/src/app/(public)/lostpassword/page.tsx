      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
        {showMessageScreen ? (
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 text-left">
              2.Or you may request a new password reset after 15 minutes.
            </p>
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 text-center">
              If you need any assistance, please <a href="/contact" className="text-blue-600 hover:underline dark:text-blue-400">contact us</a>.
            </p>
          </div>
        ) : (
          // Password recovery form
          <div>
            <h2 className="text-2xl font-bold text-center text-gray-800 dark:text-white">Password Recovery</h2>
